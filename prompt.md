...
Наши амбиции разбились о скалы реальности


Напиши, пожалуйста, реферат к диплому на 1-1.5 страниц.
Напиши в формате latex.
Писать шапку и заголовочные файлы не нужно это уже есть.
Также не используй никаких выделения текста
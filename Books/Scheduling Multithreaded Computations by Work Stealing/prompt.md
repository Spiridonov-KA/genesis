...
Привет!
Я буду тебе скидывать по частям свой диплом для магистратуры в формате pdf. Проанализируй его.
Вот первая часть.

Вот следующая часть диплома.


обр

А это накладывает какие-нибудь обременения?


Андрей, привет!
Меня до пятницы(включительно) на работе не будет
Просто у меня диплом в пятницу и у нас по докам геморрой и надо постоянно ездить в вуз.
Я с Андреем Калинкином договорился, что в выходные эти дни отработаю.
Извини, что так получилось


Банки в которых получаем в зарплату
Дом.рф есть предложения интереснее
Получить одобренее

Услуга договор на подбор 250`000
Юристы проверяют чистоту 
+ торг

Консультация ипотечников

Сформулировать список вопросов

Мытищи
Колпакова 29 с 9 до 18
Агент Аркадий


Пока не делать резких движений
Дадут ли мне справку о том, что я у них три месяца работают
...
Мне в отчёте по работе надо написать "Задание и исходные данные"
Напиши, пожалуйста, на пол страницы


Ещё мне надо заполнить таблицу "Перечень подлежащих разработке разделов и этапы выполнения работы"

Вот её колонки:

- п/п
- Наименование раздела или этапа
- Трудоёмкость в % от полной (100%) трудоёмкости ВКР
- Срок выполнения
- Примечание
...
А скиньте пж как вы отзывы оформили



Представь, что ты мой рецензент. Сделай, пожалуйста, "заключение рецензента о выпускной квалификационной работе"
...
Как с челом вообще связаться?

Сказать, что твой друг зумер, это как признаться в нетрадиционной ориентации


Я когда заехал, он мини-баром был